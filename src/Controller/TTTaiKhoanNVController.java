...
public class TTTaiKhoanNVController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			switch(command){
				case "doimk":
					System.out.println("Vào doi mat khau");
					nv = nvDao.getNhanVien(maNV);
					nv.setMatKhau(request.getParameter("npass"));
					if(nvDao.DoiMatKhau(nv))
						error="Thành công";
					else
						error="Thất bại";
				...
				case "update":
					...
					System.out.println(nv.getTenNV()+"____"+nv.getSDT()+"____"+nv.getDiaChi()+"_________"+nv.getNgSinh());
